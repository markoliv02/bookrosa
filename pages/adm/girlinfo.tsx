  ...
  return (
    <div className="container mx-auto text-black">
      <div className="flex justify-center items-center my-5">
        <div className="grid grid-cols-3 bg-white shadow shadow-xl rounded-3xl">
          <div className="flex justify-center items-center col-span-2 bg-gradient-to-b from-[#FA00FF] to-[#FF06C8] rounded-l-3xl">
