            ...
            {girlNumberCount > 0 && (
              <div>
                ...
                <div className="flex items-end z-10 h-5/6 2xl:ml-10 -mt-24 ml-5">
                  <div>
                    <h1 className="relative text-white text-4xl lg:text-2xl md:text-xl font-semibold">
                      {AllGirls[girlNumberCount - 1]?.nome}{" "}
                      <span className="text-3xl lg:text-xl md:text-xl">
        ...
        >
          <div className="mb-82">
            ...
            <div className="flex items-center justify-center md:-mt-20 mb-10 mt-3">
              <Image
                src={AllGirls[girlNumberCount]?.destaque ? logoRosa : logoRosa}
                alt=""
                width={200}
                height={200}
              />
